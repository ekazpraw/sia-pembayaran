<?php
// class paging untuk halaman Daftar Ulang
class PagingPendaftaran{
...
// class paging untuk halaman Pembayaran
class PagingPembayaran{
	// Fungsi untuk mencek halaman dan posisi data
	function cariPosisi($batas){
		if(empty($_GET['halaman'])){
			$posisi=0;
...
// class paging untuk Jenis Bayar
class PagingBiaya{
	// Fungsi untuk mencek halaman dan posisi data
	function cariPosisi($batas){
		if(empty($_GET['halaman'])){
