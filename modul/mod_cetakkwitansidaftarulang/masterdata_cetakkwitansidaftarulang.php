...
<body>
<br><h2><span>Cetak Kwitansi</span></h2>
<form method="POST" action="modul/mod_cetakkwitansidaftarulang/masterdata_cetakkwitansidaftarulang.php">
<table>
	<tr>
...
?>
  ...
  <tr class="alts" >
    <th scope="col" colspan="1"><?php echo "<a href='javascript:void(printSpecial())'  class='tulisan' title='Cetak'><img src='../../images/print.png' border='0' style='padding-right:3px;'/> Cetak</a>"?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../../index.php?module=masterdata_cetakkwitansidaftarulang" class="tulisan" title="Back"><img src="../../images/home.png" border="0" style="padding-right:3px;" title="Back"/>Back</a>
	</th>
	</tr>
</table>
			<fieldset>			
	<?php
	$query=mysql_query("Select No_pembayaran from pembayaran_daftarulang;")
	or die("Query failed with error: ".mysql_error());
	$row=mysql_fetch_array($query);
		$query2=mysql_query("Select Nm_lengkap FROM pendaftaran;")
		or die("Query failed with error: ".mysql_error());
		$row2=mysql_fetch_array($query2);
			$query3=mysql_query("Select Biaya FROM pembayaran_daftarulang;")
			or die("Query failed with error: ".mysql_error());
			$row3=mysql_fetch_array($query3);
				$query4=mysql_query("Select Nm_biaya FROM pembayaran_daftarulang;")
				or die("Query failed with error: ".mysql_error());
				$row4=mysql_fetch_array($query4);
					$query5=mysql_query("Select Status FROM pembayaran_daftarulang;")
					or die("Query failed with error: ".mysql_error());
